...
export type PigmentLatent = [number, number, number, number, number, number, number, number]
...
export const hexToPigmentLatent = (hex: string): PigmentLatent => toPigmentLatent(mixbox.rgbToLatent(hex))
